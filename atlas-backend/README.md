...
6. Copy the App ID `realm-cli apps list` and continue with configuring / running the ["Device-TS"](https://github.com/mongodb-industry-solutions/Connected-Devices/tree/main/device-ts), which will create all the required schemas to complete the setup process

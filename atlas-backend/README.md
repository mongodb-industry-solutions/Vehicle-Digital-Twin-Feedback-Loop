...
12. Remember that for the proper execution and sync of **Ditto's Big Peer**, you'll need to create two `.env` files, one inside `vehicle-ts` and the other inside `mobile-swift/src`, both with:
